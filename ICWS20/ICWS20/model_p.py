...
if __name__ == "__main__":
    ...
    for fn in os.listdir("ICWS20/ICWS20/data/platform"):

        model = Model(input_size, hidden_size, num_layers, num_classes).to(device)
        seq_dataset = generate(f"ICWS20/ICWS20/data/platform/{fn}")
        ...
        np.save(f"ICWS20/ICWS20/output/{fn.split('_')[0]}_ps.npy", anormaly_score)
